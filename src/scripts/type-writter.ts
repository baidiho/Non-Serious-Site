export default function typewriterScript() {
  ...
  const mockText =
    ...
    "This isn't serious site. I've tried to show that i know something features of Front-End development. As you can see i am not designer and in some aspects this site doesn`t pretty. Excuse me for this designer pain, that you have felt xD. " +
